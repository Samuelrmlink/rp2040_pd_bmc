#ifndef _SAMHEDRICK_PICO_PDINTERROGATOR_REV_D_RP2040_H
#define _SAMHEDRICK_PICO_PDINTERROGATOR_REV_D_RP2040_H

// For board detection
#define SAMHEDRICK_PICO_PDINTERROGATOR_REV_D_RP2040
